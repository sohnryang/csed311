...
void Valu___024root__trace_chg_0_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgSData(oldp+0,(vlSelf->A),16);
    bufp->chgSData(oldp+1,(vlSelf->B),16);
    bufp->chgCData(oldp+2,(vlSelf->FuncCode),4);
    bufp->chgSData(oldp+3,(vlSelf->C),16);
    bufp->chgBit(oldp+4,(vlSelf->OverflowFlag));
}
